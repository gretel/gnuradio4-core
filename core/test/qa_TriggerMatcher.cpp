...
const boost::ut::suite<"BasicTriggerNameCtxMatcher"> triggerTest = [] {
    ...
    "BasicTriggerNameCtxMatcher Tests"_test = [] {
        ...
        constexpr auto createTag = [](std::string triggerName, std::string cxt) noexcept { return Tag(0, {{tag::TRIGGER_NAME.shortKey(), triggerName}, {tag::CONTEXT_KEY.shortKey(), cxt}, {tag::TRIGGER_META_INFO.shortKey(), property_map{}}}); };
